...
extension Date {
    ...
    static var now: Date {
        return Calendar.current.date(byAdding: .second, value: TimeZone.current.secondsFromGMT(), to: Date())!
    }
    
    func mounthYearString() -> String {
    ...
    func currentDate(byFormatter formatter: String) -> String {
    ...
    func string(byFormatter formatter: String) -> String {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = formatter
        dateFormatter.locale = .current
    ...
    func formatInDate(mode: UIDatePicker.Mode = .date) -> String {
        let dateFormatter = DateFormatter()
        dateFormatter.timeZone = TimeZone.autoupdatingCurrent
        dateFormatter.locale = .current
        switch mode {
